...
#End Region
    ...
    Private Sub GUI_set(ByVal new_lang As String)
        ...
        If language_settings.language_RTL_layout = False Then
            '************ PANEL01 ********************
            Picture_heb_panel1.Location = New Point(Panel1.Width - Picture_heb_panel1.Width - 10, 8)
            Picture_eng_panel1.Location = New Point(Panel1.Width - Picture_heb_panel1.Width - 10, 32)
            groupbox_plate_geo.Location = New Point(9, 59)
            label_a.Location = New Point(7, label_a.Location.Y)
            label_b.Location = New Point(7, label_b.Location.Y)
            label_t.Location = New Point(7, label_t.Location.Y)
            numeric_a.Location = New Point(190, numeric_a.Location.Y)
            numeric_b.Location = New Point(190, numeric_b.Location.Y)
            numeric_t.Location = New Point(190, numeric_t.Location.Y)
            label_unit_m01.Location = New Point(267, label_unit_m01.Location.Y)
            label_unit_m02.Location = New Point(267, label_unit_m02.Location.Y)
            label_unit_mm01.Location = New Point(267, label_unit_mm01.Location.Y)
            groupbox_general.Location = New Point(377, 59)
            Label_pressure.Location = New Point(12, 25)
            textbox_P_input.Location = New Point(194, 30)
            combobox_P_units.Location = New Point(252, 30)
            Label_E.Location = New Point(8, 80)
            textbox_E_input.Location = New Point(194, 79)
            Label_GPa.Location = New Point(260, 80)
            label_ni.Location = New Point(8, 110)
            textbox_ni_input.Location = New Point(194, 110)
            Label_BC.Location = New Point(8, 140)
            numeric_case_input.Location = New Point(194, 140)
            button_BC_select.Location = New Point(252, 138)
            GroupBox_stiffeners.Location = New Point(9, 237)
            GroupBox_stiffeners_geometric.Location = New Point(6, GroupBox_stiffeners_geometric.Location.Y)
            GroupBox_stiffeners_number.Location = New Point(136, GroupBox_stiffeners_number.Location.Y)
            label_long.Location = New Point(8, 30)
            label_short.Location = New Point(8, 66)
            numeric_long.Location = New Point(129, 30)
            numeric_short.Location = New Point(129, 66)
            Label_data_unit.Location = New Point(8, 30)
            data_units.Location = New Point(125, 30)
            Button_data_change.Location = New Point(218, 27)
            Label_central01.Location = New Point(8, 90)
            TextBox_a.Location = New Point(201, 90)
            Label_non_central01.Location = New Point(8, 120)
            TextBox_na.Location = New Point(201, 120)
            Label_central02.Location = New Point(8, 180)
            TextBox_b.Location = New Point(201, 180)
            Label_non_central02.Location = New Point(8, 210)
            TextBox_nb.Location = New Point(201, 210)
            GroupBox_numeric_stiffeners.Location = New Point(377, 237)
            Label_longitudinals02.Location = New Point(12, 146)
            Label_b_change.Location = New Point(157, 146)
            Label_d_change.Location = New Point(259, 146)
            Label_central03.Location = New Point(12, 172)
            Label_non_central03.Location = New Point(12, 200)
            TextBox_Ia_b.Location = New Point(167, 172)
            TextBox_Ina_b.Location = New Point(167, 200)
            TextBox_Ia_d.Location = New Point(257, 172)
            TextBox_Ina_d.Location = New Point(257, 200)
            Label_transverse02.Location = New Point(12, 233)
            Label_central04.Location = New Point(12, 263)
            Label_non_central04.Location = New Point(12, 291)
            TextBox_Ib_b.Location = New Point(167, 264)
            TextBox_Inb_b.Location = New Point(167, 292)
            TextBox_Ib_d.Location = New Point(257, 264)
            TextBox_Inb_d.Location = New Point(257, 292)
            '************ PANEL02 ********************
            Picture_heb_panel2.Location = New Point(Panel2.Width - Picture_heb_panel2.Width - 10, 8)
            Picture_eng_panel2.Location = New Point(Panel2.Width - Picture_heb_panel2.Width - 10, 32)
            Button_compute.Location = New Point(18, 8)
            Button_more_error.Location = New Point(18, 62)
            label_msg01.Location = New Point(203, 8)
            Textbox_results.Location = New Point(464, 12)
            RichTextBox_results.Location = New Point(18, 115)
            Label_SD.Location = New Point(211, 77)
            NumericUpDown_SD.Location = New Point(653, 77)
            '************ PANEL03 ********************
            Picture_heb_panel3.Location = New Point(Panel3.Width - Picture_heb_panel3.Width - 10, 8)
            Picture_eng_panel3.Location = New Point(Panel3.Width - Picture_heb_panel3.Width - 10, 32)
            GroupBox_choose_language.Location = New Point(20, 24)
            RichTextBox_result_for_saving.Location = New Point(20, 295)
            button_results_clear.Location = New Point(203, 527)
            button_results_save.Location = New Point(315, 527)
            '************ PANEL04 ********************
            Picture_heb_panel4.Location = New Point(Panel4.Width - Picture_heb_panel4.Width - 10, 8)
            Picture_eng_panel4.Location = New Point(Panel4.Width - Picture_heb_panel4.Width - 10, 32)
        Else
            '********** PANEL1 **************
            Picture_heb_panel1.Location = New Point(10, 8)
            Picture_eng_panel1.Location = New Point(10, 32)
            groupbox_plate_geo.Location = New Point(Panel1.Size.Width - 9 - 339, 59)
            groupbox_general.Location = New Point(Panel1.Size.Width - 9 - 339 * 2 - 29, 59)
            GroupBox_numeric_stiffeners.Location = New Point(Panel1.Size.Width - 9 - 339 * 2 - 29, 237)
            GroupBox_stiffeners.Location = New Point(Panel1.Size.Width - 9 - 339, 237)
            label_a.Location = New Point(162, label_a.Location.Y)
            label_b.Location = New Point(162, label_b.Location.Y)
            label_t.Location = New Point(162, label_t.Location.Y)
            numeric_a.Location = New Point(95, numeric_a.Location.Y)
            numeric_b.Location = New Point(95, numeric_b.Location.Y)
            numeric_t.Location = New Point(95, numeric_t.Location.Y)
            label_unit_m01.Location = New Point(16, label_unit_m01.Location.Y)
            label_unit_m02.Location = New Point(16, label_unit_m02.Location.Y)
            label_unit_mm01.Location = New Point(16, label_unit_mm01.Location.Y)
            Label_pressure.Location = New Point(149, 25)
            textbox_P_input.Location = New Point(96, 30)
            combobox_P_units.Location = New Point(6, 30)
            Label_E.Location = New Point(149, 80)
            textbox_E_input.Location = New Point(96, 80)
            Label_GPa.Location = New Point(39, 80)
            label_ni.Location = New Point(149, 110)
            textbox_ni_input.Location = New Point(96, 110)
            Label_BC.Location = New Point(149, 140)
            numeric_case_input.Location = New Point(96, 140)
            button_BC_select.Location = New Point(6, 138)
            GroupBox_stiffeners_geometric.Location = New Point(6, GroupBox_stiffeners_geometric.Location.Y)
            GroupBox_stiffeners_number.Location = New Point(136, GroupBox_stiffeners_number.Location.Y)
            label_long.Location = New Point(63, 30)
            label_short.Location = New Point(63, 66)
            numeric_long.Location = New Point(5, 30)
            numeric_short.Location = New Point(5, 66)
            Label_data_unit.Location = New Point(204, 30)
            data_units.Location = New Point(116, 30)
            Button_data_change.Location = New Point(12, 27)
            Label_central01.Location = New Point(122, 90)
            TextBox_a.Location = New Point(8, 90)
            Label_non_central01.Location = New Point(122, 120)
            TextBox_na.Location = New Point(8, 120)
            Label_central02.Location = New Point(122, 180)
            TextBox_b.Location = New Point(8, 180)
            Label_non_central02.Location = New Point(122, 210)
            TextBox_nb.Location = New Point(8, 210)
            Label_longitudinals02.Location = New Point(186, 146)
            Label_b_change.Location = New Point(87, 146)
            Label_d_change.Location = New Point(13, 146)
            Label_central03.Location = New Point(186, 172)
            Label_non_central03.Location = New Point(186, 200)
            TextBox_Ia_b.Location = New Point(100, 172)
            TextBox_Ina_b.Location = New Point(100, 200)
            TextBox_Ia_d.Location = New Point(17, 172)
            TextBox_Ina_d.Location = New Point(17, 200)
            Label_transverse02.Location = New Point(186, 233)
            Label_central04.Location = New Point(186, 263)
            Label_non_central04.Location = New Point(186, 291)
            TextBox_Ib_b.Location = New Point(100, 264)
            TextBox_Inb_b.Location = New Point(100, 292)
            TextBox_Ib_d.Location = New Point(17, 264)
            TextBox_Inb_d.Location = New Point(17, 292)
            '********** PANEL2 **************
            Picture_heb_panel2.Location = New Point(10, 8)
            Picture_eng_panel2.Location = New Point(10, 32)
            Button_compute.Location = New Point(Panel2.Width - 182 - 30, 8)
            Button_more_error.Location = New Point(Panel2.Width - 182 - 30, 62)
            label_msg01.Location = New Point(Panel2.Width - 182 - 30 - 255 - 10, 8)
            Textbox_results.Location = New Point(Panel2.Width - 182 - 30 - 255 - 10 - 244 - 10, 12)
            RichTextBox_results.Location = New Point(Panel2.Width - 686 - 30, 115)
            Label_SD.Location = New Point(Button_more_error.Location.X - Label_SD.Width - 20, 77)
            NumericUpDown_SD.Location = New Point(Button_more_error.Location.X - Label_SD.Width - 20 - NumericUpDown_SD.Width - 20, 77)
            '************ PANEL03 ********************
            Picture_heb_panel3.Location = New Point(10, 8)
            Picture_eng_panel3.Location = New Point(10, 32)
            GroupBox_choose_language.Location = New Point(Panel3.Width - GroupBox_choose_language.Width - 10, 24)
            RichTextBox_result_for_saving.Location = New Point(Panel3.Width - RichTextBox_result_for_saving.Width - 10, 295)
            button_results_clear.Location = New Point((Panel3.Width - button_results_clear.Width) / 2 + 200, 527)
            button_results_save.Location = New Point((Panel3.Width - button_results_save.Width) / 2 + 10, 527)
            '************ PANEL04 ********************
            Picture_heb_panel4.Location = New Point(10, 8)
            Picture_eng_panel4.Location = New Point(10, 32)
        End If
        If general_settings.general_variables.current_model = "Orthotropic Plate model" Then
